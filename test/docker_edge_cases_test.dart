...
void main() {
  group('MlocateDBParser Edge Cases with Docker DB', () {
    test('Parses db with edge cases (spaces, special chars) successfully', () {
      ...
      var spacesDir = parser.rootNode!.children.firstWhere(
        (n) => n.label == 'spaces in name',
      );
      ...
      var specialCharsDir = parser.rootNode!.children.firstWhere(
        (n) => n.label == 'special_chars',
      );
      ...
      var nanduDir = parser.rootNode!.children.firstWhere(
        (n) => n.label == 'ñandú',
      );
      ...
      // Check 'large_dir'
      var largeDir = parser.rootNode!.children.firstWhere(
        (n) => n.label == 'large_dir',
      );
